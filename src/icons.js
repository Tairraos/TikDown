...
'    <path fill-rule="evenodd" d="M5.753 10.82 4.907 13H3L7.026 3h1.908L13 13h-1.92l-.853-2.18H5.753Zm3.804-1.715L7.982 5.077 6.419 9.105h3.138Z" clip-rule="evenodd"/>',
'</symbol>',
...
'    <path fill-rule="evenodd" d="M13 2H3a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1ZM3 0a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V3a3 3 0 0 0-3-3H3Z" clip-rule="evenodd"/>',
'</symbol>',
'<symbol id="icon-manual" viewBox="0 0 16 16">',
'    <path fill-rule="evenodd" d="M13 2H3a1 1 0 0 0-1 1v10a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1ZM3 0a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V3a3 3 0 0 0-3-3H3Z" clip-rule="evenodd"/>',
'    <path fill-rule="evenodd" d="M3.293 12.806a1 1 0 0 1 0-1.414l8.099-8.1a1 1 0 1 1 1.414 1.415l-8.099 8.099a1 1 0 0 1-1.414 0Z" clip-rule="evenodd"/>',
'    <path d="M9.32 3.95 8.934 3H7.027L4.84 8.43l3.008-3.007.134-.346.06.152L9.32 3.95Zm.907 6.87h-2.12l2.849-2.848L13 13h-1.92l-.853-2.18Z"/>',
'</symbol>',
...
'</symbol>',
'<symbol id="icon-unknown" viewBox="0 0 80 45">',
'    <rect width="80" height="45" fill="#D9D9D9" rx="4"/>',
'    <path fill="#010101" d="m39.04 23.264.528-1.128 4.224-2.952-2.664-2.736-6.024 3.24L34 17.648 40.792 14l1.392.24 4.224 4.344-.168 1.752-4.776 3.312.384 3.912-2.28.36-.528-4.656Zm-.552 9.216 1.032-2.856 2.88.984-1.032 2.88-2.88-1.008Z"/>',
'</symbol>',
